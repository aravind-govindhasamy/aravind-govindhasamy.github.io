...
And now [Circuit Digest Cloud](https://www.circuitdigest.cloud/) at Semicon Media:
...
- [GeoLinker](https://circuitdigest.com/wiki/geolinker-esp32-sim868-cellular-iot-gps-tracking-development-board/) for GPS tracking with polygon geofencing, on an ESP32-S3 and SIM868 board.
- Even [LiteWing](https://circuitdigest.com/wiki/litewing/), a 45-gram Wi-Fi drone, because at some point an ordinary IoT device stopped being enough of a challenge.
